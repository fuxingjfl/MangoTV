...
public class IndexAdapter extends BaseQuickAdapter <String,BaseViewHolder>{
    ...
    public IndexAdapter(@LayoutRes int layoutResId, @Nullable List data, List<Boolean> xz, Context context, RegionChoiceListener regionChoiceListener) {
