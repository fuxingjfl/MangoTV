...
public class CustomSlideToUnlockView extends RelativeLayout {
    ...
    private void init(TypedArray mTypedArray) {
        ...
        textSize=mTypedArray.getInteger(R.styleable.SlideToUnlockView_textSize_fh, 7);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE://上滑才处理,如果用户一开始就下滑,则过掉不处理
                        ...
                        Log.e("TAG","控件的宽度:::"+rl_slide.getWidth()+",滑块的宽度:::"+iv_slide.getWidth()+"据前面:::"+layoutParams.leftMargin);

                        if(mSlidedDistance>0){//右滑
                            Log.e("TAG","右侧");
                            if(layoutParams.leftMargin>=(rl_slide.getWidth()-iv_slide.getWidth())){//滑块在最右侧
                            ...
                            Log.e("TAG","左侧");
                            if(layoutParams.leftMargin<=0){//滑块在最左侧
