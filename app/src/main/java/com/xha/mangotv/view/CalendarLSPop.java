 ...
 * 
 */
public class CalendarLSPop extends PopupWindow {
	private int resId;
	...
	private TextView tv_time_qt,tv_time_wj,tv_time_hj,tv_rl_content;
	...
	private String time;
	public CalendarLSPop(Context context, int resId
