...
/**
 * Created by ysq on 2018/10/9.
 */

public class TimeSlotPop extends PopupWindow {
    private int resId;
    ...
    private TextView tv_time_duan;
    public TimeSlotPop(Context context, int resId
    ...
    public void initPopupWindow() {
        ...
        tv_time_duan=defaultView.findViewById(R.id.tv_time_duan);
