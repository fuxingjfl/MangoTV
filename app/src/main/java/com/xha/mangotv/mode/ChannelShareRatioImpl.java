...
/**
 * Created by ysq on 2018/10/22.
 */

public class ChannelShareRatioImpl implements DataModel,OkHttpClientManager.HttpCallback {
    ...
    public void onSuccess(String result, int code) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("TAG","走错误方法了dddddddddddddddddddddd");
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
            Log.e("TAG","走错误方法了cccccccccccccccccccccc");
        }
